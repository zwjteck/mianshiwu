...
_e(function (E, $) {
    ...
    DropList.fn.initDOM = function () {
        ...
        var $list = $('<div class="wangEditor-drop-list clearfix"><div class="wangEditor-drop-list-arr"></div></div>');
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        head: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-header"></i><i class="wangeditor-menu-arr"></i></a>',
            selected: '.selected'
        },
        orderlist: {
        ...
        link: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-link"></i>超链接</a>',
            selected: '.selected'
        },
        unlink: {
        ...
        table: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-table"></i>表格</a>',
            selected: '.selected'
        },
        emotion: {
        ...
        img: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-picture"></i>图片</a>',
            selected: '.selected'
        },
        video: {
        ...
        insertcode: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-code"></i>代码块</a>',
            selected: '.selected'
        },
        undo: {
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        */
        ...
        // 定义 update selected 事件
        menu.updateSelectedEvent = function (ev) {
            // console.log(menu)
            // console.log(ev)
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'font[face]');
            var _face = editor.currentRange().endContainer.parentElement.face;
            $('.wangeditor-menu-img-font2').text(_face || 'Arial')
            // debugger
            if (rangeElem) {
                return true;
            }
    ...
    E.createMenu(function (check) {
        ...
        */
        ...
        menu.updateSelectedEvent = function () {
            ...
            var sizes = [12,13,16,18,24,32,48]
            $('.wangeditor-menu-img-text-height').text(sizes[editor.currentRange().endContainer.parentElement.size - 1] || 16)
            if (rangeElem) {
                return true;
            }
            return false;
