(function () {
    ...
    E.createMenu(function (check) {
        ...
        var menu = new E.Menu({
            ...
            $domNormal: $('<a href="#" tabindex="-1">插入</a>'),
            $domSelected: $('<a href="#" tabindex="-1" class="selected">插入</a>')
        });

        // 菜单正常状态下，点击将触发该事件
        menu.clickEvent = function (e) {
          $('.wangEditor-menu-container .menu-group:nth-child(7)').toggleClass('fn-inline')
        };
